...
fetch("http://localhost:3000/api/teddies")
    ...
    .then(function (listeDeProduits) {
        ...
        //Sélection de la classe qui contiendra le produit et injection dans le HTML 
        ...
        //Sélection de la classe qui contiendra les options et injection dans le HTML
        ...
        buttonPanier.addEventListener("click", (e) => {
            ...
            //Récupération de la clé 'article' pour savoir si elle contient quelque chose
            ...
            // Si le local storage contient des articles, rajouter le produit
            if (articleAjoute) {
                articleAjoute.push(produitCommande);
                localStorage.setItem("article", JSON.stringify(articleAjoute));
            }
            // Si le local storage est vide, créerun tableau et y envoyer le produit
            else {
                articleAjoute = [];
                articleAjoute.push(produitCommande);
                localStorage.setItem("article", JSON.stringify(articleAjoute));
